...
nameInput.addEventListener('input', checkpaynowButton);
contactInput.addEventListener('input', checkpaynowButton);
deliveryCheckbox.addEventListener('change', checkpaynowButton);
...
viewCartButton.addEventListener('click', showDrawer);
